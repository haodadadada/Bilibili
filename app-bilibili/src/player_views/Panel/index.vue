    ...
    <div class="container-panel">
        <header class="tab-area">
            <div class="tab-wrap flex-center flex-between">
                <div class="tab-left size-15 flex-center pb-5">
                    ...
                    <span class="flex-center tab-comment">
                        ...
                        <span class="size-12 count">{{ formatView(props.reply) }}</span>
                    </span>
                ...
                <transition name="opacity-fade">
                    <div class="tab-panel" v-if="tabPanelState">
                        <div class="reload-btn size-13 weight-6">
...
<script setup lang="ts">
    ...
    const reloadPlayerWindow = () => {
        window.electronAPI.sendMessage('player_reload');
    };

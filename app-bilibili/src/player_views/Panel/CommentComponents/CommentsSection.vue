    ...
    <div class="container">
        ...
        <section class="content" ref="allCommentsRef" @scroll="handleScroll">
            <div v-if="!isLoadingComments">
                    ...
                    <span class="size-12 cat-btn" :class="{'active': catBtnIndex === 0}" @click="handleClickCatBtn(0)">最热</span>
                    <span class="vertical-line"></span>
                    <span class="size-12 cat-btn" :class="{'active': catBtnIndex === 1}" @click="handleClickCatBtn(1)">最新</span>
                </div>
                ...
                <div v-if="isEnd" class="nomore-comment text-center size-13">没有更多评论</div>
                <div v-if="!isLogin && !isEnd" class="nomore-comment text-center size-13">登录查看更多评论</div>
            </div>
            <div v-if="isLoadingComments" class="size-12 text-center" style="color: var(--text2-color);">正在加载...</div>

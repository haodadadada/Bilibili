    ...
    <div class="player-content flex-center">
        <div class="player-video-area flex-center" v-ratio="{ratio: 1.7}">
            ...
            >
                    ...
                    >
                        ...
                        <div class="player-control-bottom flex">
                            <div class="player-control-bottom-left flex-start flex-1">
                                ...
                                <div class="player-ctrl-time flex-start size-12 mr-20">
                                ...
                                <div class="player-danmaku-area flex-start">
                                    ...
                                    <div class="player-danmaku-setting mr-18">
                                        ...
                                        <transition name="opacity-fade">
                                            <div class="setting-wrap" v-if="isShowSetting">
                                                <div class="setting-show-wrap">
                                                    <span class="size-12 mr-5">显示区域</span>
                                                    ...
                                                    <span class="size-12 ml-10 progress-val">{{ realDanmakuShowArea }}%</span>
                                                </div>
                                                <div class="setting-opacity-wrap mt-5">
                                                    <span class="size-12 mr-5">不透明度</span>
                                                    ...
                                                    <span class="size-12 ml-10 progress-val">{{ danmakuOpacity }}%</span>
                                                </div>
                                                <div class="setting-size-wrap mt-5">
                                                    <span class="size-12 mr-5">弹幕字号</span>
                                                    ...
                                                    <span class="size-12 ml-10 progress-val">{{ danmakuSize }}%</span>
                                                </div>
                                                <div class="setting-speed-wrap mt-5">
                                                    <span class="size-12 mr-5">弹幕速度</span>
                                                    ...
                                                    <span class="size-12 ml-10 progress-val">{{ speedProgressVal }}</span>
                                                </div>
                                            </div>
                                        </transition>
                                    </div>
                            ...
                            <div class="player-control-bottom-right flex-end flex-1">
                                ...
                                <!-- 倍速 -->
                                <div class="player-ctrl-playbackrate player-ctrl-btn size-14 weight-6">
                                    <transition name="opacity-fade">
                                ...
                                <!-- 字幕 -->
                                <div class="player-ctrl-subtitle player-ctrl-btn">
                ...
                <!-- 隐藏简介按钮 -->
                <div class="player-hide-introduce-btn flex-center" :style="isShowIntroduce ? 'transform: translateY(-50%)' : 'transform: translateY(-50%) rotate(180deg)'" v-show="isMouseMoving" @click.capture="handleClickHideIntroduceBtn">
...
<script setup lang="ts">
    import { ref, Ref, inject, watch, onMounted, onUnmounted, nextTick, computed } from 'vue';
    ...
    const speedProgressVal = computed(() => {
        switch (true) {
    ...
    const getProgressLeftNum = (value: number, min: number, max: number) => (value - min) / (max - min) * 100;

<template>
    <div class="container-hot">
        <header class="nav-tabs flex-between flex-center">
            <div class="tab flex-1 mr-10 size-14" v-for="tab of tabList" :key="tab.index" @click="updateTabActiveIndex(tab.index)" :class="{'tab-active': tabActiveIndex === tab.index}">{{ tab.title }}</div>
        </header>

                        ...
                        <div class="card-cover mb-10">
                            ...
                            <div class="card-mask">
                                <div class="corner-tag-vip pl-14 pr-5 flex-center" v-if="card.badge_type === 0">
                                    ...
                                    <span class="size-13 text-cenrer">{{ card.badge }}</span>
                                </div>
                                <div class="corner-tag-belong pl-10 pr-5 flex-center" v-if="card.badge_type === 1">
                                    <span class="size-13 text-center">{{ card.badge }}</span>
                                </div>
                                <div class="card-mask-info flex-end">
                                    <div class="card-mask-info-right weight-5 size-13">{{ card.desc }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="card-info">
                            <div class="card-title size-13">{{ card.title }}</div>
                        </div>
                    </div>
                </div>
            </section>

        ...
        <ExitDialog v-if="isShow">
          <div class="flex-column flex-between popup">
            ...
            <div class="flex-start flex-column dialog-content flex-1">
              <div class="size-16 weight-6 mb-15 item title">点击关闭按钮以后：</div>
              <div class="size-13 mb-10 item">
                  <input type="radio" id="hide" name="close" :value="0" v-model="selectIndex">
                  <label for="hide">最小化到系统托盘</label>                
              </div>
              <div class="size-13 item">
...
<script setup lang="js">
  ...
  const removeFontListener = window.electronAPI.receive('update_font_to_main', (fontIndex) => {
    if(fontIndex === 0) {
      document.body.style.fontFamily = 'system-ui, sans-serif';
      return;
    }
